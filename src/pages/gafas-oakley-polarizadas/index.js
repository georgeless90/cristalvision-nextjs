...
function GafasOakleyPolarizados(props) {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "@id": "https://www.cristalvision.online/gafas-oakley-polarizadas/#webpage",
    url: "https://www.cristalvision.online/gafas-oakley-polarizadas",
    name: "Gafas oakley polarizadas | ¡En ofertas llamativas y rápido envío!",
    description:
      "Descubre ahora las opciones que tenemos para ti, en gafas oakley polarizadas, aprovecha estas impresionantes ofertas ingresando aquí.",
    inLanguage: "es",
    isPartOf: {
      "@type": "WebSite",
    ...
    primaryImageOfPage: {
      "@type": "ImageObject",
      "@id": "https://www.cristalvision.online/gafas-oakley-polarizadas/#primaryimage",
      inLanguage: "es",
      url: "https://www.cristalvision.online/oakley.jpg",
      contentUrl: "https://www.cristalvision.online/oakley.jpg",
      width: "900",
      height: "563",
      caption: "gafas oakley polarizadas",
    },
    breadcrumb: {
      "@type": "BreadcrumbList",
      "@id": "https://www.cristalvision.online/gafas-oakley-polarizadas/#breadcrumb",
      itemListElement: {
        "@type": "ListItem",
        position: "1",
        name: "Home",
  ...
  return (
    <main className="page">
      <Head>
        <title>
          Gafas oakley polarizadas | ¡En ofertas llamativas y rápido envío!
        </title>
        <meta
          name="description"
          content="Descubre ahora las opciones que tenemos para ti, en gafas oakley polarizadas, aprovecha estas impresionantes ofertas ingresando aquí."
        />
        <link
          rel="canonical"
          href="https://www.cristalvision.online/gafas-oakley-polarizadas"
        />
        
      </Head>
      <Header allCategories={props.categoriesList} />
      <TitleCreadCrumbs
        title={"Gafas oakley polarizadas"}
      ...
      <div className="page_body">
        <p className="page_body_paragraph">
          ...
          últimos años. Incluidos en esos productos novedosos están, las gafas
          oakley polarizadas, que en la actualidad son muy buscadas tanto en
        ...
        <p className="page_body_paragraph">
          ...
          estructuramos una lista creada de gafas oakley polarizadas, para
          mostrar.
        </p>
        ...
        <div className="best_and_selleing_product_cont">
          ...
          <p className="page_body_paragraph">
            ...
            gafas oakley polarizadas, fueron compradas por un mayor número de
        ...
        <ul>
          <li className={styles.ul_li_text}>
            Las gafas oakley polarizadas, innovaron con la óptica patentada de
        ...
        <div className="page_body_subtitle">
          <h2 className="subtitle_text">
            Directamente de la base de datos, las gafas oakley polarizados
...
export default GafasOakleyPolarizados;
